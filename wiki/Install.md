...
* jsDelivr: https://cdn.jsdelivr.net/npm/ccxt@0.0.1/dist/ccxt.browser.js
* unpkg: https://unpkg.com/ccxt@0.0.1/dist/ccxt.browser.js
...
```HTML
<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/ccxt@0.0.1/dist/ccxt.browser.js"></script>
```
